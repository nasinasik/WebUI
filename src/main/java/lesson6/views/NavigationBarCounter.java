...
public class NavigationBarCounter extends BaseView {

    public NavigationBarCounter(WebDriver driver) {
        super(driver);
    }
    ...
    public NavigationBarCounter checkTabVisibility(NavigationBarTabs tab) {
